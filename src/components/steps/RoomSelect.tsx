...
export function RoomSelect() {
  ...
  return (
    <>
      ...
      <div className="mb-3 px-3.5 py-2 rounded-card border bg-ink-card border-ink-border text-[11px] text-tx-mid">
        Choose the room that best frames your brief. Each room maps to a
        distinct service angle — Growth, Capital, Risk, World.
      </div>
